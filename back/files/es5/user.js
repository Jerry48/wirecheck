            ...
            success: function success(data) {
                if (data.code == 0) {
                    ...
                    for (var i = 0; i < list.length; i++) {
                        ...
                        $("#main table tbody").append("<tr id='" + list[i].userId + "' class='infolist' usertype='" + list[i].userType + "' department='" + list[i].department + "' mobile='" + list[i].mobile + "' groupid='" + list[i].groupId + "'><td><input type='checkbox' name=''></td><td>" + (i + 1) + "</td><td>" + list[i].name + "</td><td>" + list[i].userName + "</td><td>" + userType + "</td><td>" + groupName + "</td><td>" + list[i].department + "</td></tr>");
                    }
                    if (list.length < 35) {
