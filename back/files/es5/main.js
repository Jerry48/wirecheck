                    ...
                    $.ajax({
                        ...
                        success: function success(data) {
                            if (data.code == 0) {
                                ...
                                var contentTemplte = "<div style='width:100%;height:100%;'id='tmpid'>" + "<div style='float:left;width:30%;'><h5 style='margin:0px;'>名字</h5><p style='margin:0px;'>电压</p><p style='margin:0px;'>充电电压</p><p style='margin:0px;'>温度</p><p style='margin:0px;'>警报</p><p style='margin:0px;'>状态</p></div>" + "<div id='pics' style='float:left;width:70%; height:50px;'><img id='imgDemo' width='350' height='200' src='thumbnail' data-original='url' title='告警图片'/><button type='button' class='mapLastPic'>上一张</button><button type='button' class='mapNextPic'>下一张</button></div>" + "</div>";
