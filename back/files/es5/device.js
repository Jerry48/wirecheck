...
$(function () {
	...
	$('#uploadConfirm').click(function () {
		...
		$.ajax({
			...
			xhr: function xhr() {
				...
				if (progressHandler && myXhr.upload) {
	...
	function dataTableInit(data) {
		...
		var dt = $('#dt1').DataTable({
			...
			scrollX: true,
			destroy: true,
			columns: [{ "data": null }, { "data": "deviceName" }, { "data": "deviceTele" }, { "data": "version" }, { "data": "area" }, { "data": "lineName" }, { "data": "deviceDangerID" }, //6
			{ "data": "status" }, //7
			{ "data": "heartBeatTime" }, { "data": "temperature" }, //9
			{ "data": "batteryVoltage" }, { "data": "batterySolarVoltage" }, { "data": "capacityVoltage" }, { "data": "networkSignal" }, //13
			{ "data": "countPicDay" }, { "data": "countPicMonth" }, { "data": "latitude" }, { "data": "longitude" }, { "data": "deviceId" }],
			"columnDefs": [{
	...
	function dataTable2Init(data) {
		...
		var dt = $('#dt2').DataTable({
			...
			scrollX: false,
			destroy: true,
			columns: [{ "data": null }, { "data": null }, { "data": "deviceName" }, { "data": "deviceTele" }, { "data": "version" }, { "data": "area" }, { "data": "lineName" }, { "data": "deviceDangerID" }, { "data": "deviceId" }, { "data": "deviceId" }],
			columnDefs: [{
				"render": function render(data, type, row, meta) {
