...
describe('device.list.devicetags', function () {
	...
	it('device_1_list_devicetags', function (done){
		this.timeout(50000);
		var index = 0;
	...
	it('device_2_list_devicetags', function (done){
		this.timeout(50000);
		var index = 1;
	...
	it('device_3_list_devicetags', function (done){
		this.timeout(50000);
		var index = 2;
	...
	it('device_4_list_devicetags', function (done){
		this.timeout(50000);
		var index = 3;
