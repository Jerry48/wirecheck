// device query group edit API test 
...
describe('query.device.group.edit', function () {
	...
	it('query_device_group_1  edit', function (done){
		this.timeout(50000);
		var index = 0;
	...
	it('query_device_group_2 edit', function (done){
		this.timeout(50000);
		var index = 1;
	...
	it('query_device_group_3 edit', function (done){
		this.timeout(50000);
		var index = 2;
	...
	it('query_device_group_4 edit', function (done){
		this.timeout(50000);
		var index = 3;
