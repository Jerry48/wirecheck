...
describe('device.details', function () {
	...
	it('device_1  details', function (done){
		this.timeout(50000);
		var index = 0;
	...
	it('device_2 details', function (done){
		this.timeout(50000);
		var index = 1;
	...
	it('device_3 details', function (done){
		this.timeout(50000);
		var index = 2;
	...
	it('device 4 details', function (done){
		this.timeout(50000);
		var index = 3;
