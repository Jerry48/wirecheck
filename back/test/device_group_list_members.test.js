// device group list members API test 
...
var URLPATH = '/v1/device/group/listmembers';
...
describe('device.group.list.members', function () {
	...
	it('device_group_1  list members', function (done){
		this.timeout(50000);
		var index = 0;
	...
	it('device_group_2 list members', function (done){
		this.timeout(50000);
		var index = 1;
	...
	it('device_group_3 list members', function (done){
		this.timeout(50000);
		var index = 2;
	...
	it('device_group_4 list members', function (done){
		this.timeout(50000);
		var index = 3;
