...
var URLPATH = '/v1/device/group/search';
...
describe('device.group.search', function () {
	...
	it('device group1 search', function (done){
		this.timeout(50000);
		var index = 0;
	...
	it('device group2 search', function (done){
		this.timeout(50000);
		var index = 1;
	...
	it('device group3 search', function (done){
		this.timeout(50000);
		var index = 2;
	...
	it('device group4 search', function (done){
		this.timeout(50000);
		var index = 3;
