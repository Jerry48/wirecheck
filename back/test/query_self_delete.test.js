// device self query group delete api test 
...
describe('query.device.group.delete', function () {
	...
	it('query device_group_1_delete', function (done){
		this.timeout(50000);
		var index = 0;
	...
	it('query device_group_2_delete', function (done){
		this.timeout(50000);
		var index = 1;
	...
	it('query device_group_3_delete', function (done){
		this.timeout(50000);
		var index = 2;
	...
	it('query device_group_4_delete', function (done){
		this.timeout(50000);
		var index = 3;
