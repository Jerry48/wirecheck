...
var URLPATH = '/v1/device/group/create';
...
describe('device.group.create', function () {
	...
	it('device_group_1  create', function (done){
		this.timeout(50000);
		var index = 0;
	...
	it('device_group_2 create', function (done){
		this.timeout(50000);
		var index = 1;
	...
	it('device_group_3 create', function (done){
		this.timeout(50000);
		var index = 2;
	...
	it('device_group_4 create', function (done){
		this.timeout(50000);
		var index = 3;
