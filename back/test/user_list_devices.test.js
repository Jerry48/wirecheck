...
var URLPATH = '/v1/user/device/list';
...
describe('user.list.all.devices', function () {
	...
	it('user1_list_all_devices', function (done){
		this.timeout(50000);
		var index = 0;
	...
	/*it('user2_list_all_devices', function (done){
		this.timeout(50000);
		var index = 1;
	...
	it('user3_list_all_devices', function (done){
		this.timeout(50000);
		var index = 2;
	...
	it('user4_list_all_devices', function (done){
		this.timeout(50000);
		var index = 3;
