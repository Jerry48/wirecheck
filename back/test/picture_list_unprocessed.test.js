// list all unprocessed pics test 
...
describe('picture.list.unprocessed', function () {
	...
	it('pic1_list_unprocessed', function (done){
		this.timeout(50000);
		var index = 0;

		var params = '&name='+pics[index].name;
	...
	it('pic2_list_unprocessed', function (done){
		this.timeout(50000);
		var index = 1;
	...
	it('pic3_list_unprocessed', function (done){
		this.timeout(50000);
		var index = 2;
	...
	it('pic4_list_unprocessed', function (done){
		this.timeout(50000);
		var index = 3;
