// device group list groups API test 
...
var URLPATH_GROUP = '/v1/device/listgroup';
var URLPATH_PATROL = '/v1/device/listpatrol';
...
describe('device.group.list.groups', function () {
	...
	it('device_group_1 list groups', function (done){
		this.timeout(50000);
		var index = 0;
...
//test invalid data
	it('device_group_2 list groups', function (done){
		this.timeout(50000);
		var index = 1;
	...
	it('device_group_3 list groups', function (done){
		this.timeout(50000);
		var index = 2;
	...
	it('device_group_4 list groups', function (done){
		this.timeout(50000);
		var index = 3;
