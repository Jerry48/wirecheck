// user group list groups API test 
...
describe('user.group.list.groups', function () {
	...
	it('group 1 list groups', function (done){
		this.timeout(50000);
		var index = 0;
...
//test invalid data
	it('group 2 list groups', function (done){
		this.timeout(50000);
		var index = 1;
	...
	it('group 3 list groups', function (done){
		this.timeout(50000);
		var index = 2;
	...
	it('group 4 list groups', function (done){
		this.timeout(50000);
		var index = 3;
