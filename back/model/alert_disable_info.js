//  alert disable config info data model and API
 ...
 */
'use strict';
var model_name = 'alert_disable_info.model';
var table_name = 'tb_alert_disable_info';
...
var refModel = {
    id : 'record id',
    deviceId: '', //告警信息来源设备id
    dayOfWeek: 0, //0-sun, 1-mon,2-,
    fromTime: new Date(), //撤防开始时间
    toTime: new Date(),//撤防截止时间
    startHour: 1,
    startMinute: 1,
    endHour: 2,
    endMinute:2,
