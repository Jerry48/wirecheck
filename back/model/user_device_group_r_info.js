//  device group info data model and API
 ...
 */
'use strict';
var model_name = 'user_device_group_r_info.model';
var table_name = 'tb_user_device_group_r_info';
...
var refModel = {
    id : 'record id',
    groupId: 'groupId',
    groupType: 0, //0-普通设备分组，1-巡查分组，2-标签,3-推送分组
    userId: 'userId',
    userType: 0, //0-操作员，1-管理员
    comment: 'comment',
    createTime: new Date(), //
    updateTime: new Date(),
    state: 0,
