//  tower heart beat lose info data model and API
...
'use strict';
var model_name = 'heart_beat_lose_log.model';
var table_name = 'tb_heart_beat_lose_log';
...
var refModel = {
    ...
    deviceId: '', //监控设备id
    deviceName: 'name',
    heartBeatLogId: '', //失联前一条心跳记录id
    loseTime: new Date(), //失联前一条心跳记录时间
    createTime: new Date(),
    updateTime: new Date(),
    state: 0,
};
