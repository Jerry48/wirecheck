// device character info data model and API
 ...
 */
'use strict';
var model_name = 'device_character_info.model';
var table_name = 'tb_device_character_info';
...
var refModel = {
    id : 'record id',
    deviceId: 'device id',
    type: 0, //0-line, 1-tower,2-date,4-datetime
    text: 'text',
    x: 0,
    y: 1,
    enable: 0, //0-no, 1-yes
