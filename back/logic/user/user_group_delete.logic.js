...
'use strict';  
var moduleName = 'user_group_delete.logic';
...
function processRequest(param, fn){
    ...
    async.series([
    	...
    	function(next){
    		...
    		groupModel.remove(query, next);
    	}
    ], 
    function(err){
    	if (err) {
    		console.error('Failed to delete group for'+groupId);
    		fn(err);
    	}else{
    		debug('Success to delete group for:'+groupId);
