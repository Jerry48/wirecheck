...
'use strict';  
var moduleName = 'device_tree_priv.logic';
var URLPATH = '/v1/device/tree/priv';
...
function processRequest(param, fn){
    ...
    debug('Try to list the child of device level of '+groupId);
    ...
    async.waterfall([
            ...
            if(parentIds.length==0){
                ...
                deviceLevelModel.query(query, function(err, rows){
                    if (err) {
                        ...
                        next(null,{result:result,data:data2});
                    }
                });
            }
        },
            ...
            if(parentIds.length==0){
                ...
                deviceLevelModel.query(query, function(err, rows){
                    if (err) {
                        ...
                        var data3 = tmp;
                        console.log(data3);
                        next(null,{result:result,data:data3});
                    }
                });
            }
        },
        ...
        function(data3,next){
            console.log('############### 3');
            var result = data3.result;
            var data3 = data3.data;
            var parentIds = [];
            ...
            if(parentIds.length==0){
                ...
                deviceLevelModel.query(query, function(err, rows){
                    if (err) {
                        ...
                        var data4 = tmp;
                        console.log(data4);
                        next(null,{result:result,data:data4});
                    }
                });
            }
        },
        ...
        function(data4,next){
            console.log('############### 4');
            var result = data4.result;
            var data4 = data4.data;
            var parentIds = [];
            var data4 = JSON.parse(JSON.stringify(data4));
    ...
    function(err, result){
        if (err) {
            console.error('Failed to list device Level!'+groupId);
            fn(err);
        }else{
            debug('Success to list the device Level:'+groupId);
